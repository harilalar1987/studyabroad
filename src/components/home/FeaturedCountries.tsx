  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading title="Featured Destinations" subtitle="Top countries for international students" />
          ...
          {featured.map((country, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="aspect-[4/3] bg-gradient-to-br from-navy-800 to-navy-600 flex items-center justify-center relative overflow-hidden">
                    <img
                      src={paths.flag}
                      alt={country.name}
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          ...
                          span.className = 'text-6xl font-changa text-white/80'
        ...
        {countries.length > 4 && (
          <div className="text-center mt-10">
            <Link
              to="/countries"
              className="inline-flex items-center gap-2 text-sky-400 font-semibold hover:text-sky-500 transition-colors"
            >
              View All Countries
